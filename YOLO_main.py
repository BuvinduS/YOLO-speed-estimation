...
while True:
    ...
    results = model.track(img, persist=True, tracker="botsort.yaml", classes=[2], conf=0.5, device='cpu') #iou == intersection over union, 2 is the class of car
